...
You can find out more, including a detailed implementation guide by checking out the homepage, [Innovation Sandbox on AWS](https://aws.amazon.com/solutions/implementations/innovation-sandbox-on-aws/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el)
...
* [Year One of Valkey: Open-Source Innovations and ElastiCache version 8.1 for Valkey](https://aws.amazon.com/blogs/database/year-one-of-valkey-open-source-innovations-and-elasticache-version-8-1-for-valkey/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - a retrospective of a year of Valkey, and how support for this open source project has grown from strength to strength

* [Introducing Strands Agents 1.0: Production-Ready Multi-Agent Orchestration Made Simple](https://aws.amazon.com/blogs/opensource/introducing-strands-agents-1-0-production-ready-multi-agent-orchestration-made-simple/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - is the first of a series of posts that looks at Strands Agents, an open source SDK that takes a model-driven approach to building and running AI agents in just a few lines of code that can scale from simple to complex agent use cases, and from local development to deployment in production [hands on] (check out [part two](https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-2-authentication-on-mcp/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) and [part three](https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-3-strands-agents-mcp/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) of this series)

* [Post-quantum TLS in Python](https://aws.amazon.com/blogs/security/post-quantum-tls-in-python/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - looks at how you can test Post-quantum TLS in Python applications with boto3 and other Python libraries, that will help protect your applications against potential quantum computer (CRQC) attacks
...
* [Scaling beyond IPv4: integrating IPv6 Amazon EKS clusters into existing Istio Service Mesh](https://aws.amazon.com/blogs/containers/scaling-beyond-ipv4-integrating-ipv6-amazon-eks-clusters-into-existing-istio-service-mesh/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - provides a step-by-step guide for combining IPv6-enabled EKS clusters with your existing Istio Service Mesh and IPv4 workloads, enabling a graceful transition to IPv6 on AWS [hands on]
* [GitOps continuous delivery with ArgoCD and EKS using natural language](https://aws.amazon.com/blogs/devops/gitops-continuous-delivery-with-argocd-and-eks-using-natural-language/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - explores how to use Amazon Q CLI together with Model Context Protocol (MCP) to transforming complex Kubernetes operations into simple conversational interactions [hands on]
...
* [Announcing Valkey GLIDE 2.0 with support for Go, OpenTelemetry, and batching](https://aws.amazon.com/blogs/database/announcing-valkey-glide-2-0-with-support-for-go-opentelemetry-and-batching/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - looks at the next generation client for Valkey, GLIDE 2.0 covering why it was created and then providing examples of how to use it [hands on]
...
* [Compaction support for Avro and ORC file formats in Apache Iceberg tables in Amazon S3](https://aws.amazon.com/blogs/big-data/compaction-support-for-avro-and-orc-file-formats-in-apache-iceberg-tables-in-amazon-s3/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - examines the performance benefits of automatic compaction of Iceberg tables using Avro and ORC file types in S3 Tables for a data ingestion use with over 20 billion events [hands on]
* [Introducing MCP Server for Apache Spark History Server for AI-powered debugging and optimization](https://aws.amazon.com/blogs/big-data/introducing-mcp-server-for-apache-spark-history-server-for-ai-powered-debugging-and-optimization/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - shows you how to get started with the new open source MCP Server that will help you use generative AI tools like Amazon Q Developer to simplify performance troubleshooting and optimisation by examining your Apache Spark History Server [hands on]
...
* [Volatility classification in PostgreSQL](https://aws.amazon.com/blogs/database/volatility-classification-in-postgresql/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - dives deep into how properly categorising functions as VOLATILE, IMMUTABLE, or STABLE allows PostgreSQL’s optimiser to make informed decisions, leading to more efficient query plans [hands on]
* [Fully Sharded Data Parallel with Ray on Amazon ECS](https://aws.amazon.com/blogs/containers/fully-sharded-data-parallel-with-ray-on-amazon-ecs/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - looks at how you can use model sharding techniques such as Fully Sharded Distributed Data Parallel (FSDP) on Amazon ECS that will help you to optimise your costs to run training for models with billions of parameters [hands on]
* [Use AWS FIS to test the resilience of self-managed Cassandra](https://aws.amazon.com/blogs/database/use-aws-fis-to-test-the-resilience-of-self-managed-cassandra/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - reviews how you can use AWS FIS to craft a chaos experiment to test the resilience of your self-managed Cassandra clusters running on Amazon EC2 [hands on]

* [Overcome your Kafka Connect challenges with Amazon Data Firehose](https://aws.amazon.com/blogs/big-data/overcome-your-kafka-connect-challenges-with-amazon-data-firehose/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - shows how Amazon Data Firehose provides a straightforward way to deliver data from Apache Kafka to Amazon S3, enabling you to save costs and reduce latency to seconds [hands on]
* [Building serverless event streaming applications with Amazon MSK and AWS Lambda](https://aws.amazon.com/blogs/big-data/building-serverless-event-streaming-applications-with-amazon-msk-and-aws-lambda/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - explores how to simplify your event-driven application architecture using AWS Lambda with Apache Kafka, showing  how to configure Lambda as a consumer for Kafka topics, including a cross-account setup and then how to optimise price and performance for these applications [hands on]

**Other posts to check out**

* [Preview Release of the AWS SDK Java 2.x HTTP Client built on Apache HttpClient 5.5.x](https://aws.amazon.com/blogs/developer/preview-release-of-theaws-sdk-java-2-x-http-client-built-on-apache-httpclient-5-5-x/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - provides details of the new AWS SDK for Java 2.x that introduces the Apache 5 SDK HTTP client which is built on Apache HttpClient 5.5.x [hands on]
* [Implementing message prioritization with quorum queues on Amazon MQ for RabbitMQ](https://aws.amazon.com/blogs/compute/implementing-message-prioritization-with-quorum-queues-on-amazon-mq-for-rabbitmq/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - describes the different approaches to implementing message prioritisation in quorum queues in Amazon MQ for RabbitMQ [hands on]
...
* [Improve RabbitMQ performance on Amazon MQ with AWS Graviton3-based M7g instances](https://aws.amazon.com/blogs/big-data/improve-rabbitmq-performance-on-amazon-mq-with-aws-graviton3-based-m7g-instances/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) - is a quick post that looks at benchmarks comparing performance and cost characteristics when using AWS Graviton based instances for your Amazon MQ infrastructure 
...
There were a couple of great blog posts that looked at this in more details. Starting off with [Under the hood: Amazon EKS ultra scale clusters](https://aws.amazon.com/blogs/containers/under-the-hood-amazon-eks-ultra-scale-clusters/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) which looks under the hood and provides copious amounts of graphs. After reading that check out [Amazon EKS enables ultra scale AI/ML workloads with support for 100K nodes per cluster](https://aws.amazon.com/blogs/containers/amazon-eks-enables-ultra-scale-ai-ml-workloads-with-support-for-100k-nodes-per-cluster/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el) which looks at some of the ways you might be able to use that scale.
...
Dive deeper by reading [Introducing Amazon Keyspaces CDC streams](https://aws.amazon.com/blogs/database/introducing-amazon-keyspaces-cdc-streams/?trk=71546b8e-c969-4ead-aa9f-9cd06f6d8610&sc_channel=el).
